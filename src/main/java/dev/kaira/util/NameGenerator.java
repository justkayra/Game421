...
public class NameGenerator {
    ...
    final private static char[] consonants = {'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w',
            'x', 'y'};
    ...
    public String compose(int syls) {
        ...
        do {
            c = (int) (Math.random() * sur.size());
                ...
                && consonantFirst(pureSyl(sur.get(c))) == false || last == 1 && hatesPreviousVowels(sur.get(c)) || last == 2
